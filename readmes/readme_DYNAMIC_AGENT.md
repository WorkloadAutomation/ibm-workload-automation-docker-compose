...
To start the container from the command-line, launch the following command by adding the name of the image that has been loaded:
    ...
    docker run \
        ...
        ibm-workload-automation-agent-dynamic:<version_number>.<release_date>
...
For details about custom certificates, see the [online](https://www.ibm.com/docs/en/workload-automation/10.2.8?topic=guide-configuring-secure-communications) documentation.
